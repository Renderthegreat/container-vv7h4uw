...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vv7h4uw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vv7h4uw.containers.anotherwebservice.com/
...
```
git clone git@github.com:Renderthegreat/container-vv7h4uw.git
cd container-vv7h4uw
```
...
```
docker attach container-vv7h4uw
```
